...
```bash
$ git clone git@github.com:username/g11n4js.git
```

This will clone your fork to your current path in a directory named `g11n4js`.
...
```bash
$ cd g11n4js
$ git remote add upstream git@github.com:ibm-dojo/g11n4js.git
$ git fetch upstream
```
